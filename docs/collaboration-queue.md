...
| TAI-005 | Review | loyputh | Invoice workbench | Split `InvoiceManager.tsx` into intake, table, review, and robot draft subcomponents | `npm run check` | PR #22 is open and CI is passing; no visual redesign in this task. |
...
| TAI-011 | Active | Codex | Maintenance rhythm | Keep the collaboration queue, public issues, and release readiness notes updated weekly | GitHub issue/release checks | 2026-06-08 maintenance sync completed; continue reviewing stale issues and release readiness. |
